...
var login = require('./mock/login.ts');
var newOpro = require('./mock/newOpro.ts');
var indexList = require('./mock/seriesList.ts');
var banners = require('./mock/banner.ts');
var menu = require('./mock/menu.ts');
var hotSearch = require('./mock/hotSearch.ts');
